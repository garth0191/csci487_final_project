                ...
                <form action="course_create.php" method="post">
                    ...
                    <div class="create-container">
                        ...
                        Semester: <select name='semester'>
                            ...
                            <?php
                                $pullSemesters = $conn->prepare("SELECT * FROM SEMESTER");
                                $pullSemesters->execute();
                                while ($oneSemester = $pullSemesters->fetch(PDO::FETCH_ASSOC)) {
                                    $semester_id = $oneSemester["semester_id"];
                                    $semester_name = $oneSemester["semester_name"];
                                    echo "<option name='semester' value='$semester_id'>$semester_name</option>";
                                }
                            ?>
                        </select><br>
