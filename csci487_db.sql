...
ALTER TABLE GRADE DROP FOREIGN KEY GRADE_TYPE;
...
ALTER TABLE GRADE ADD CONSTRAINT GRADE_ASSESSMENT FOREIGN KEY (assessment_id)
    REFERENCES ASSESSMENT (assessment_id) ON DELETE CASCADE;
ALTER TABLE GRADE ADD CONSTRAINT GRADE_TYPE FOREIGN KEY (score_type)
    REFERENCES SCORE_TYPE (score_id) ON DELETE CASCADE;
